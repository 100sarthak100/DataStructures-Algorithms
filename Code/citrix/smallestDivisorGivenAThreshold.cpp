...
// we will choose a positive integer divisor and divide all the 
// array by it and sum the result of the division. Find the 
...
// Output: 5
// Explanation: We can get a sum to 17 (1+2+5+9) if the divisor 
// is 1. 
...
class Solution {
public:
    int sums(vector<int> &nums, int mid)
    {
        int total = 0;
